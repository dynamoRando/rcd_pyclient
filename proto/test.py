...
def run():
    ...
    with grpc.insecure_channel('localhost:50051') as channel:
        ...
        response = stub.IsOnline(
            cdata_pb2.TestRequest(requestEchoMessage='test1'))
    print("Greeter client received: " + response.replyEchoMessage)


def test_create_db():
    auth = cdata_pb2.AuthRequest(userName="tester", pw="123456")
    request = cdata_pb2.CreateUserDatabaseRequest(
...
# python3 -m grpc_tools.protoc -I . --python_out=. --grpc_python_out=. cdata.proto
